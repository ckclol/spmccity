package com.willfp.eco.api.core.command;
...
public abstract class AbstractTabCompleter implements TabCompleter {
    /**
     * The {@link com.willfp.eco.core.command.AbstractCommand} that is tab-completed.
     */
    private final com.willfp.eco.core.command.AbstractCommand command;

    /**
     * Create a tab-completer for a specified {@link com.willfp.eco.core.command.AbstractCommand}.
     *
