    ...
    public void setitemdefdam(PlayerInteractEvent e) {
        ...
        if (e.getAction() == Action.LEFT_CLICK_AIR || e.getAction() == Action.LEFT_CLICK_BLOCK) {
            ...
            if (!itemdamage.has(strength, PersistentDataType.INTEGER)) {
                itemdamage.set(strength, PersistentDataType.INTEGER, ItemCreator.Strength);
                itemdamage.set(damage, PersistentDataType.INTEGER, ItemCreator.Damage);
            }
        }
    }
}
